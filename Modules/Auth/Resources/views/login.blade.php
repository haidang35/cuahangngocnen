    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(admin/assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form method="POST" action="{{  route('auth.login.post') }}" class="form-horizontal form-material" id="loginform" >
                       @csrf
                        <h3 class="text-center m-b-20">Đăng nhập</h3>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input name="email" class="form-control" type="email" placeholder="Tài khoản"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input name="password" class="form-control" type="password" placeholder="Mật khẩu"> </div>
                        </div>
                    ...
                    <form class="form-horizontal" id="recoverform" action="https://eliteadmin.themedesigner.in/demos/bt4/crm/index.html">
                        <div class="form-group ">
                            <div class="col-xs-12">
...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/crm/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2023 06:49:29 GMT -->
</html>