                    ...
                    <table id="example23" class="table table-bordered m-t-30 table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#model{{$customer->id}}" class="btn btn-sm btn-danger">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="model{{$customer->id}}Label">Xác nhận Khôi phục khách hàng</h4>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <h4>Bạn đã chắc chắn khôi phục khách hàng <b>{{ $customer->name }}</b></h4>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-info waves-effect text-white" data-bs-dismiss="modal">Hủy bỏ</button>
                                                    <a href="{{ route('customer.restore', ['id' => $customer->id]) }}" type="button" class="btn btn-danger waves-effect text-white" >Có, Chắc chắn xóa</a>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
